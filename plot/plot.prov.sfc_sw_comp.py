...
### Calculate Ratio
sfc_direct_cld_ratio = 100. * (sfc_direct_all - sfc_direct_clr) / sfc_direct_clr
sfc_direct_aer_ratio = 100. *(sfc_direct_clr - sfc_direct_pri) / sfc_direct_pri

sfc_diffuse_cld_ratio = 100. * (sfc_diffuse_all - sfc_diffuse_clr) / sfc_diffuse_clr
sfc_diffuse_aer_ratio = 100. * (sfc_diffuse_clr - sfc_diffuse_pri) / sfc_diffuse_pri

sfc_global_cld_ratio = 100. * (sfc_direct_all + sfc_diffuse_all - sfc_direct_clr -
                        sfc_diffuse_clr) / (sfc_direct_clr + sfc_diffuse_clr)
sfc_global_aer_ratio = 100. * (sfc_direct_clr + sfc_diffuse_clr - sfc_direct_pri -
                        sfc_diffuse_pri) / (sfc_direct_pri + sfc_diffuse_pri)

sfc_direct_ratio_all = 100. * sfc_direct_all / (sfc_direct_all + sfc_diffuse_all)
sfc_direct_ratio_clr = 100. * sfc_direct_clr / (sfc_direct_clr + sfc_diffuse_clr)
sfc_direct_ratio_pri = 100. * sfc_direct_pri / (sfc_direct_pri + sfc_diffuse_pri)
...
for i in range(len(pro_nm)):
    color[pro_nm[i]] = sfc_direct_ratio_pri[i]
...
for key, value in patches.iteritems():
    ...
    ax.add_collection(PatchCollection(value,\
        ...
        cmap=cm.rainbow, edgecolor='k', linewidth=1., zorder=2))
...
plt.savefig('prov_sfc_sw_direct_ratio_prisky.ps',format='ps')
