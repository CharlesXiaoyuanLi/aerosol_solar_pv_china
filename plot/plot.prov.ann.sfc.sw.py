...
sfc_direct_ratio_noaero = 100. * sfc_direct_noaero / (sfc_direct_noaero + sfc_diffuse_noaero)
...
for i in range(len(pro_nm)):
    color[pro_nm[i]] = sfc_direct_ratio_noaero[i]
...
plt.savefig('prov_sfc_sw_direct_ratio_noaero.ps',format='ps')
